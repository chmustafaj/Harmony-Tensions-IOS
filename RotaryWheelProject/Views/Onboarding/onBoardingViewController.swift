...
class onBoardingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        super.viewDidLoad()
        slides = [onBoardingSlide(image: UIImage(named: "screen_1.jpg")!, title: "Harmony Tensions", description: "Explore the art of musical improvisation with Harmony Tensions, an engaging platform designed for solo or group play."), onBoardingSlide(image: UIImage(named: "screen_2.jpg")!, title: "Select a Key", description: "Use the harmony wheel to select a key for the chord progression"),onBoardingSlide(image: UIImage(named: "screen_3.jpeg")!, title: "Start game",description: "Choose between random or song mode. Play along with a song, or select from two modes in random mode" ), onBoardingSlide(image: UIImage(named: "screen_4.jpeg")!, title: "Play along", description: "Get your instrument and start jamming with the chords displayed. Green notes are current;yellow are next"), onBoardingSlide(image: UIImage(named: "screen_5.jpg")!, title: "Switch modes", description: "Switch up the modes and try between secondary donimants, or diminished. Or play along with a song.")]
